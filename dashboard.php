...
header('location:index.php');
   ...
   $casualLeaves    = getLeavesAvailed('casual');
   $medicalLeaves   = getLeavesAvailed('medical');
   $pLeaves         = getLeavesAvailed('pleave');
   $totalLeaves     = $casualLeaves + $medicalLeaves + $pLeaves;
?>
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="stats-counter"><span><?php echo $totalLeaves;?></span></span>
...
?>   
                                <span class="stats-counter"><span><?php echo htmlentities($approvedleaves);?></span></span>
                        ...
                        <div class="col s15 m12 l12">
                            <div class="card invoices-card">
                             ...
                             <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql ="SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,DATE_FORMAT(tblleaves.PostingDate,'%d %M, %Y')AS PostingDate,tblleaves.Status from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.empid='$eid' order by lid desc limit 6";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{         
      ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities(getLeaveType($result->LeaveType));?></td>
