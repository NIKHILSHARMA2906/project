...
if(isset($_POST['signin']))
{
    ...
    if( !isset($uname) || empty($uname) ){
        ...
        $results =mysqli_query($conn, "SELECT EmailId,Password,Status,id FROM tblemployees WHERE EmailId='$uname' and Password='$password'") or die($GLOBALS['conn']);
