...
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,tblleaves.LeaveType,DATE_FORMAT(tblleaves.ToDate,'%d %M, %Y') AS ToDate,DATE_FORMAT(tblleaves.FromDate,'%d %M, %Y') AS FromDate,tblleaves.Description,DATE_FORMAT(tblleaves.PostingDate,'%d %M, %Y')AS PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.id=:lid";
      ...
      ?>  
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Employe Name :</b></td>
                                              ...
                                              <td><?php echo htmlentities(ucfirst($result->Gender));?></td>
                                          </tr>
...
<tr>
                                             <td style="font-size:16px;"><b>Employe Leave Reason : </b></td>
